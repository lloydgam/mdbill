...
[assembly: OwinStartup(typeof(mdbill.Startup))]
...
namespace mdbill
{
    public class Startup
    {
        ...
        {
            app.CreatePerOwinContext<MdbillContext>(() => new MdbillContext());
        ...
        {
            var userStore = new UserStore<IdentityUser>(context.Get<MdbillContext>());
